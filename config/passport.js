...
module.exports = function (passport) {
    ...
    function(req, username, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'local.email' :  username }, function(err, user) {
            ...
            if (!user)
                return done(null, false, req.flash('loginMessage', 'Wrong login credentials!')); // req.flash is the way to set flashdata using connect-flash

            // if the user is found but the password is wrong
            if (!user.validPassword(password))
                return done(null, false, req.flash('loginMessage', 'Wrong login credentials!')); // create the loginMessage and save it to session as flashdata
